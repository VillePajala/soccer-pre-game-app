...
-- Add constraints
ALTER TABLE players ADD CONSTRAINT players_user_id_name_key UNIQUE(user_id, name) ON CONFLICT DO NOTHING;
ALTER TABLE seasons ADD CONSTRAINT seasons_user_id_name_key UNIQUE(user_id, name) ON CONFLICT DO NOTHING;
ALTER TABLE tournaments ADD CONSTRAINT tournaments_user_id_name_key UNIQUE(user_id, name) ON CONFLICT DO NOTHING;
