...
import { 
  ...
  useSeasonTournamentModalSelector 
...
describe('useSeasonTournamentModalState', () => {
  describe('Zustand Implementation', () => {
    ...
    it('should open modal when open is called', () => {
      ...
      expect(mockOpenModal).toHaveBeenCalledWith('seasonTournamentModal');
    });
    ...
    it('should close modal when close is called', () => {
      ...
      mockUseUIStore.mockImplementation((selector: any) => {
        const mockStore = {
          modals: { seasonTournamentModal: true },
          openModal: jest.fn(),
      ...
      expect(mockCloseModal).toHaveBeenCalledWith('seasonTournamentModal');
    });
  });
  ...
  describe('Context Implementation (Legacy)', () => {
    ...
    it('should call context setter when opening modal', () => {
      ...
      mockUseModalContext.mockReturnValue({
        isSeasonTournamentModalOpen: false,
        setIsSeasonTournamentModalOpen: mockSetIsOpen,
  ...
  describe('useSeasonTournamentModalWithHandlers', () => {
    ...
    it('should provide enhanced handlers', () => {
      ...
      expect(typeof result.current.openSeasonTournamentModal).toBe('function');
      expect(typeof result.current.closeSeasonTournamentModal).toBe('function');
    });
  });

  describe('useSeasonTournamentModalSelector', () => {
    it('should return Zustand state when not in legacy mode', () => {
      ...
      mockUseUIStore.mockImplementation((selector: any) => {
        const mockStore = { modals: { seasonTournamentModal: true } };
        return typeof selector === 'function' ? selector(mockStore) : mockStore;
      });

      const { result } = renderHook(() => useSeasonTournamentModalSelector());
    ...
    it('should return context state when in legacy mode', () => {
      ...
      mockUseModalContext.mockReturnValue({
        isSeasonTournamentModalOpen: true,
        setIsSeasonTournamentModalOpen: jest.fn(),
        // Add other required context properties
        isGameSettingsModalOpen: false,
        setIsGameSettingsModalOpen: jest.fn(),
