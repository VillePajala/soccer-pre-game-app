...
export type TranslationKey =
  ...
  | 'playerAssessment.assessedCount'
  | 'playerAssessment.awareness'
  | 'playerAssessment.courage'
  | 'playerAssessment.creativity'
  | 'playerAssessment.decisions'
  | 'playerAssessment.duels'
  | 'playerAssessment.fair_play'
  | 'playerAssessment.impact'
  | 'playerAssessment.intensity'
  | 'playerAssessment.notes'
  | 'playerAssessment.overall'
  | 'playerAssessment.saveAndMarkDone'
  | 'playerAssessment.teamwork'
  | 'playerAssessment.technique'
  | 'playerAssessment.title'
  | 'playerStats.assists'
  | 'playerStats.gameLog'
