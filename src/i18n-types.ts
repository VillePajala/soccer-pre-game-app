...
export type TranslationKey =
  ...
  | 'settingsModal.sendBackupPrompt'
  | 'settingsModal.sendBackupSuccess'
  | 'settingsModal.signOutDescription'
  | 'settingsModal.storageUsageDetails'
  | 'settingsModal.storageUsageLabel'
  | 'settingsModal.storageUsageUnavailable'
  | 'settingsModal.title'
  | 'sidebarCategories.account'
  | 'sidebarCategories.analysisTools'
  | 'sidebarCategories.gameManagement'
  | 'sidebarCategories.resources'
  | 'sidebarCategories.settings'
  | 'sidebarCategories.setupConfiguration'
