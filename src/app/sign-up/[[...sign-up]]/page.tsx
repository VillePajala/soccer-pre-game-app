...
export default function SignUpPage() {
  return (
    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      {/* Sign-up modal container with enforced padding */}
          ...
          <div className="w-full max-w-md mx-auto">
            <SignUp
              appearance={{
                baseTheme: dark,
                variables: {
                  colorPrimary: '#7c3aed', // Matching purple color
                },
                elements: {
                  card: 'shadow-xl w-full', 
                  formButtonPrimary: 'text-sm font-semibold normal-case tracking-wide',
