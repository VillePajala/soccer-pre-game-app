...
export default function StorageDebug() {
  ...
  useEffect(() => {
    ...
    setEnvVars({
      NEXT_PUBLIC_ENABLE_SUPABASE: String(process.env.NEXT_PUBLIC_ENABLE_SUPABASE ?? 'undefined'),
      NEXT_PUBLIC_SUPABASE_URL: process.env.NEXT_PUBLIC_SUPABASE_URL ? 'SET' : 'NOT_SET',
      NEXT_PUBLIC_SUPABASE_ANON_KEY: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? 'SET' : 'NOT_SET',
      NEXT_PUBLIC_DISABLE_FALLBACK: String(process.env.NEXT_PUBLIC_DISABLE_FALLBACK ?? 'undefined'),
    });
  }, []);
